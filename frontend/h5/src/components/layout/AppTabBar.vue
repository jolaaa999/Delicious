...
const tabs: TabItem[] = [
  { key: 'inspiration', label: '找灵感', path: '/inspiration', icon: 'spark' },
  { key: 'kitchen', label: '我的厨房', path: '/kitchen', icon: 'pot' },
]
...
const activeTab = computed<TabKey>(() => {
  ...
  if (tab) return tab
  return route.path.startsWith('/kitchen') ? 'kitchen' : 'inspiration'
})
